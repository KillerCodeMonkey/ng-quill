            ...
            return {
                ...
                link: function ($scope, element, attr, ngModel) {
                    var config = {
                        ...
                        editor,
                        setClass = function () {
                            // if editor content length <= 1 and content is required -> add custom error class and ng-invalid
                            if ($scope.required && (!$scope.modelLength || $scope.modelLength <= 1)) {
                                element.addClass('ng-invalid');
                                element.removeClass('ng-valid');
                                // if form was reset and input field set to empty
                    ...
                    $scope.required = $scope.required && $scope.required === 'true';
                    ...
                    $scope.$watch(function () {
                        ...
                        changed = false; // and keep watching for any non text-change changes to model!
                                         // what if we need to change model from controller?!
